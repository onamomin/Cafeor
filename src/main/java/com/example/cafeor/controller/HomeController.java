package com.example.cafeor.controller;
...
import com.example.cafeor.entity.Order;
import com.example.cafeor.entity.OrderItem;
import com.example.cafeor.entity.Product;
import com.example.cafeor.repository.CustomerRepository;
import com.example.cafeor.repository.OrderRepository;
import com.example.cafeor.repository.ProductRepository;
...
public class HomeController {
	...
	public String addToCart(@RequestParam("productId") Long proId,
			@RequestParam(name = "quantity", defaultValue = "1") int quanty,
